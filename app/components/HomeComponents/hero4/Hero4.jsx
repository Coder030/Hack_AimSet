...
const dummyData = [
    ...
    },
    {
        image: ImageOne,
        alt: 'Image Four',
        title: 'Blog title heading will go here 4',
        description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros.'
    },
    {
        image: ImageOne,
        alt: 'Image Five',
        title: 'Blog title heading will go here 5',
        description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros.'
    },
    {
        image: ImageOne,
        alt: 'Image Six',
        title: 'Blog title heading will go here 6',
        description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros.'
    }
];
        ...
        w-11/12 mx-auto'>
            ...
            <div className='mx-auto'>
                ...
                <p className='text-center hidden md:block'>
                    ...
                    <br />solve this problem. Avoid using verbose words or phrases.
                </p>
             ...
             mx-auto rounded-b-3xl'>
                {dummyData.map((item, index) => (
                    <div key={index} className='shadow-lg mx-auto rounded-b-3xl'>
                        <Image src={item.image} alt={item.alt} className="m-0 rounded-t-3xl" width={500} height={300} />
                        {/* desc */}
                        <div className='bg-[#F9FAFB] rounded-b-3xl p-8 '>
                            <h6 className='md:text-[20px] leading-[20px] font-bold
                             text-[#000000] nunito text-base
                            mb-4'>{item.title}</h6>
                            <p>{item.description}</p>
                            <button className='text-[#F9FAFB] bg-[#282828] p-3 rounded-md mt-4'>Read more</button>
                        </div>
                    </div>
                ))}
            </div>
